...
class FileAttachmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create file_attachment" do
    assert_difference('FileAttachment.count') do
      post file_attachments_url, params: { file_attachment: { created_date: @file_attachment.created_date, file: @file_attachment.file, name: @file_attachment.name } }
    end
  ...
  test "should update file_attachment" do
    patch file_attachment_url(@file_attachment), params: { file_attachment: { created_date: @file_attachment.created_date, file: @file_attachment.file, name: @file_attachment.name } }
