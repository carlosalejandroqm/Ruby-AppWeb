...
class SignatureRequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create signature_request" do
    assert_difference('SignatureRequest.count') do
      post signature_requests_url, params: { signature_request: { created_date: @signature_request.created_date, document_id: @signature_request.document_id, subject: @signature_request.subject, user_id: @signature_request.user_id } }
    end
  ...
  test "should update signature_request" do
    patch signature_request_url(@signature_request), params: { signature_request: { created_date: @signature_request.created_date, document_id: @signature_request.document_id, subject: @signature_request.subject, user_id: @signature_request.user_id } }
