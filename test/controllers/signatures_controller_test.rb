...
class SignaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create signature" do
    assert_difference('Signature.count') do
      post signatures_url, params: { signature: { created_date: @signature.created_date, file: @signature.file, name: @signature.name } }
    end
  ...
  test "should update signature" do
    patch signature_url(@signature), params: { signature: { created_date: @signature.created_date, file: @signature.file, name: @signature.name } }
